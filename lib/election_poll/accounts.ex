defmodule ElectionPoll.Accounts do
  @moduledoc """
  ...
  See `ElectionPoll.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `ElectionPoll.Accounts.User.password_changeset/3` for a list of supported options.
